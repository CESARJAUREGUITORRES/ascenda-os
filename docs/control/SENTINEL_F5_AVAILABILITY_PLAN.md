...
**Baseline main:** `00797fe87869f4cee8a11414de1f1de262e8c109`  
...
- interval: 60 s;
- timeout: 10 s;
- 3 muestras fallidas consecutivas para `DOWN`;
...
- Docker/Compose o Docker equivalente versionado;
- backup de `/app/data`;
...
| F5-G03 | Zero-PHI/PII + sin credenciales materiales | EN CI |
