...
const WA_SHELL_TAG='<script src="/wa-native-panel.js?v=20260817-wa-native-s10-p01"></script><script src="/wa-shell-integration.js?v=20260817-wa-shell-s10-p01"></script><script src="/auth-session-cookie-bridge.js?v=20260817-s7-p01"></script>';
...
function injectAppShell(html){
  let tags='';
  if(html.indexOf('/wa-native-panel.js')<0)tags+='<script src="/wa-native-panel.js?v=20260817-wa-native-s10-p01"></script>';
  if(html.indexOf('/wa-shell-integration.js')<0)tags+='<script src="/wa-shell-integration.js?v=20260817-wa-shell-s10-p01"></script>';
