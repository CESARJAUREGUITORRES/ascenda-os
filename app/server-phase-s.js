...
const WA_SHELL_TAG='<script src="/wa-performance-hardening.js?v=20260824-wa3-perf-p01"></script><script src="/wa-native-panel.js?v=20260910-wa-native-r7compact-p01"></script><script src="/wa-shell-integration.js?v=20260817-wa-shell-s11-p01"></script><script src="/auth-session-cookie-bridge.js?v=20260817-s7-p01"></script>';
...
function injectAppShell(html){
  let tags='';
  if(html.indexOf('/wa-performance-hardening.js')<0)tags+='<script src="/wa-performance-hardening.js?v=20260824-wa3-perf-p01"></script>';
  if(html.indexOf('/wa-native-panel.js')<0)tags+='<script src="/wa-native-panel.js?v=20260910-wa-native-r7compact-p01"></script>';
