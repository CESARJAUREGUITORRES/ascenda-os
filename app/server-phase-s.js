...
const WA_SHELL_TAG='<script src="/wa-native-panel.js?v=20260817-wa-native-s11-p01"></script><script src="/wa-shell-integration.js?v=20260817-wa-shell-s11-p01"></script><script src="/auth-session-cookie-bridge.js?v=20260817-s7-p01"></script>';
