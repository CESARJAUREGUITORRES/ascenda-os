...
function loadSegsPanel(){
  ...
  var x=_ctx();_rpc('aos_get_seguimientos',{p_asesor:x.a,p_id_asesor:x.id,p_hoy:x.hoy},function(rows){
    ...
    var arr=Array.isArray(rows)?rows:(rows&&Array.isArray(rows.items)?rows.items:[]);
