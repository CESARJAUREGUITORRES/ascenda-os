...
function _ctx(){var c=(window.AOS_getCtx&&window.AOS_getCtx())||{};var hh=new Date().toISOString().slice(0,10);return{a:(c.asesor||'').toUpperCase(),id:c.idAsesor||'',hoy:hh,mes:hh.slice(0,7)+'-01'};}
