...
function transform(path,html){
 ...
 if(path==='/app.html'||path==='/app'){
  var tags='';
  if(html.indexOf('/patients-360-selection-v38.js')<0)tags+='<script src="/patients-360-selection-v38.js?v=20260916-1"></script>';
  if(html.indexOf('/booking-link-center-v37.js')<0)tags+='<script src="/booking-link-center-v37.js?v=20260916-1"></script>';
