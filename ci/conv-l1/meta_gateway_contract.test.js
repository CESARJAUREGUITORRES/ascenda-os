...
assert(lock.includes('CONV-L4 #508 — BUSINESS TOOLS + BOUNDED RAG'),'post-L1 current Conversations workstream lock missing');
assert(lock.includes('INT-GOOGLE-001 #542')&&lock.includes('LOCK RELEASED'),'Google-to-CONV lock transfer evidence missing');
