...
// Professional Skill Hierarchy is a user-opened, one-shot Team RPC surface. The static census
...
// three already-certified CURRENT-main candidates. The Business Priority browser governor is a
// fetch interceptor with one one-shot status read; its setTimeouts only schedule local queue/cooldown
// work and do not create an independent recurrent network owner. Baseline these explicitly; any
// 61st owner still fails closed. CIA Audience Control Center reuses the shell observer and adds no recurrent owner.
expect('RECURRENT_FILE_BUDGET',Number(census.recurrentNetworkCandidateCount)<=60,`recurrent network candidate files ${census.recurrentNetworkCandidateCount} > 60`);
...
'app/public/admin-billing.html','app/public/admin-calls.html','app/public/admin-catalogo.html','app/public/admin-config.html','app/public/admin-email.html','app/public/admin-home.html','app/public/admin-marketing-v2-core.js','app/public/admin-sales.html','app/public/admin-team.html','app/public/admin-team-skill-hierarchy.js','app/public/admin-whatsapp-wa3.html','app/public/admin-whatsapp.html','app/public/agenda.js','app/public/agendar.html','app/public/agendar-v2.html','app/public/agendar-v3.html','app/public/agents.html','app/public/app.html','app/public/asesor-coord.html','app/public/attendance.html','app/public/auth-session-cookie-bridge.js','app/public/booking-link-center-v37.js','app/public/browser-business-priority-v1.js','app/public/caja.html','app/public/calls.html','app/public/calls.js','app/public/catalogo.html','app/public/cerebro.html','app/public/coordinacion.html','app/public/coord-lock-search-v1.js','app/public/f4-production-canary-hotfix.js','app/public/f4-revenue-ops.js','app/public/inventario.html','app/public/login.html','app/public/notification-center-s15.js','app/public/notification-push-s14.js','app/public/patients.js','app/public/rev-prc1-product-resolution-center.js','app/public/rev-sx1-sales-explorer.js','app/public/sentinel-hub-bootstrap.js','app/public/sentinel-hub.js','app/public/sentinel-inapp-notifications.js','app/public/studio-creator.html','app/public/studio.html','app/public/wa-human-alerts.js','app/public/wa-multiagent-final-panel.js','app/public/wa-multiagent-v2-panel.js','app/public/wa-native-panel.js','app/public/wa-performance-hardening.js','app/public/wa-shell-integration.js','app/server-f17.js','app/server-f4.js','app/server-f5.js','app/server-phase-s.js','app/server-phase2.js','app/server-wa2.js','app/server-wa3-v2.js','app/server-wa3.js','app/server-wa4.js','app/server.js','app/src/pages/login.js'
]);
...
const waMultiV2=read('app/public/wa-multiagent-v2-panel.js');
...
expect('WA_EVENT_DRIVEN_INBOX',waNative.includes("fetch('/api/wa3/events'")&&waNative.includes('scheduleFallback(45000)')&&waNative.includes('document.hidden?60000:45000')&&!waNative.includes('setInterval(function(){heartbeat(false);},2500)'),'native inbox is not event-driven with bounded 45s visible / 60s hidden fallback');
...
expect('WA_V2_SINGLE_INBOX_OWNER',!waMultiV2.includes("api('/api/wa3/inbox?limit=120')"),'legacy V2 regained direct inbox reads');
expect('WA_V2_EVENT_FALLBACK',waMultiV2.includes("'aos:wa3-core-event'")&&waMultiV2.includes('getInboxSnapshot')&&waMultiV2.includes('function nextPollDelay(')&&waMultiV2.includes('function scheduleRefresh(')&&waMultiV2.includes('document.hidden?60000:45000')&&waMultiV2.includes('scheduleRefresh(45000)'),'legacy V2 event/snapshot fallback contract missing');
expect('WA_V2_NO_FIXED_5S',!waMultiV2.includes("setInterval(function(){if(!document.hidden)refresh();},5000)"),'legacy V2 fixed 5s polling returned');
