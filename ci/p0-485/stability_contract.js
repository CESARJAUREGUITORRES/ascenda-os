...
function sourceContracts() {
  ...
  assert(lock.includes('RUN UNTIL BLOCKED + REAL META TEST LIMITADO A zi vital') || lock.includes('RUN UNTIL BLOCKED + REAL META TEST limitado a zi vital'), 'CONV-L1 owner authorization missing')
