...
ok(shell.includes('/cia-audience-workspace-v3.js?v=20260918-1'),'Audience Workspace V3 loader/cache-bust missing')
...
ok(workspace.includes('/rpc/aos_cia_control_center_app_v3'),'Audience Workspace must use additive gateway V3')
ok(workspace.includes("'CATALOG_META'")&&workspace.includes("'REFRESH_CATALOG'"),'catalog-first metadata/count refresh missing')
ok(workspace.includes("'PREVIEW_ALL'")&&workspace.includes("'PREVIEW'")&&workspace.includes('limit:25'),'bounded preview path missing')
ok(workspace.includes("'EXPORT_CSV'"),'governed CSV export missing')
