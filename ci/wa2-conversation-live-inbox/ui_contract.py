...
wa4_wrapped=(start=='node server-wa4.js' and wa4_authority and "['server-wa2.js']" in wa3 and 'proxy(req,res)' in wa3)
f5_wrapped=(start=='node server-f5.js' and "['server-wa4.js']" in f5 and 'proxy(req,res)' in f5 and wa4_authority and "['server-wa2.js']" in wa3 and 'proxy(req,res)' in wa3)
