...
final_mode=re.search(r'/wa-multiagent-final-panel\.js\?v=(?:20260822-wa3-final-p0[12]|20260824-wa35-[a-z0-9-]+|20260910-wa35-[a-z0-9-]+)',shell) is not None
...
assert "PUSH_SRC='/notification-push-s14.js?v=20260915-samsung-push-p02'" in shell
