...
assert "MULTI_SRC='/wa-multiagent-v2-panel.js?v=20260822-wa3-multiagent-v2-p02'" in shell
...
for token in ['AVAILABLE','AWAY','OFFLINE','/api/wa3/queue-summary','/api/wa3/presence','/api/wa3/claim-next','/api/wa3/team-summary','Tomar siguiente','Equipo WA','WA3_NOT_OWNER','ownershipLostRemount','wa3v2-owner-chip','Meta aceptó el mensaje','5000']:
    assert token in panel, token

# Ownership loss is a routing/visibility change, not an authentication failure.
