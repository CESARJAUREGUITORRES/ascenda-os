...
ok(alerts.includes('reg.showNotification(title,opts)'),'persistent service-worker notification missing');
...
ok(alerts.includes('body:safePreview(r)'),'notification message content must use safePreview');
ok(!alerts.includes('body:r.last_message_preview'),'raw message content must not bypass sanitizer');
...
ok(sw.includes('/wa-human-alerts.js?v=20260817-wa-alerts-s13-p01')||sw.includes('/wa-human-alerts.js?v=20260817-wa-alerts-s14-p01'),'service worker must inject evolved alerts');
