...
const r7prod=fs.readFileSync(path.join(root,'supabase/migrations/20260909234000_wa_s14_event_push_priority_v2.sql'),'utf8')
...
ok(push.includes("aos_push_vapid_runtime_config_v2"),'R7 runtime VAPID RPC missing')
...
ok(push.includes("aos_push_targets_for_wa_v2"),'R7 bounded queue notification target RPC missing')
...
console.log('WA S14/S15.4/S15.5 contract PASS')
