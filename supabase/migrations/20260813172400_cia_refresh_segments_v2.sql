...
begin
 ...
 select contact_key,policy_key,policy_version,policy_status,value_tier,value_score,lifecycle,engagement,engagement_score,traits,explanation,calculated_at,t from public.aos_cia_customer_segments_v1
