...
const replacements = [[oldArr,newArr,'envelope adapter'],[oldMap,newMap,'item adapter'],[oldRender,newRender,'render metadata'],[oldButton,newButton,'button metadata'],[oldCall,newCall,'segLlamar propagation']];
let changed = false;
